...
| B19 | Two-sided hip/knee brackets (rear idler) | **DEFERRED (hardware)** | D046 leaves hip and knee single-sided: all leg bending goes through the servo output shaft. VERIFY on servo arrival whether the ST3215 has a rear idler boss/hole; if yes, the femur link grows a second arm riding a bearing on it and the knee carrier likewise. |
| B20 | Case-screw servo retention | **DEFERRED (hardware)** | D046 lips + straps are independent of the (unmeasured) case holes. Measure the ST3215 case screw pattern; replace strap tap bores with case screws through the rail walls. |
