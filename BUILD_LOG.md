...
**Next**       — place recognition with the three-verdict bench (B38); speaker id + people memory (B39); sensors as params (B40); Gemma with thinking on (B41). Restart the owner's cockpit onto this code.
